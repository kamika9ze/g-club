	...
	grunt.initConfig({
		...
		less: { // Task less
			...
			dev: { // Target
				...
				files: {
					'src/assets/css/new-styles.css': ['src/assets/less/icons.less', 'src/assets/less/styles.less'],
					// 'src/*.html': ['build/*.html'],
				},
			},
			release: { // Target
				...
				files: {
					'build/assets/css/new-styles.css': ['src/assets/less/icons.less', 'src/assets/less/styles.less'],
				}
			}
		},
